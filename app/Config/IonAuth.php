...
class IonAuth extends BaseConfig
{
	 ...
	 */
	public $siteTitle                = 'diskominfo.bolmutkab.go.id';       // Site Title, example.com
	...
	public $rememberUsers            = false;                // Allow users to be remembered and enable auto-login
	public $userExpire               = 1800;               // How long to remember the user (seconds). Set to zero for no expiration
	...
	public $lockoutTime              = 300;                 /* The number of seconds to lockout an account due to exceeded attempts
	...
	public $emailConfig = [
		// 'SMTPHost' => 'cpl5.layanan.go.id',
		// 'SMTPUser' => 'webmaster@bolmutkab.go.id',
		// 'SMTPPass' => 'webmaster_bmu',
		'SMTPHost' => 'smtp.googlemail.com',
		'SMTPUser' => 'megaryu10@gmail.com',
		'SMTPPass' => 'bozlcibcgqlrcoal',
	];
