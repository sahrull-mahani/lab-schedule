...
class Kuota extends BaseController
{
    ...
    {
        $this->data = array('title' => 'Kuota | Admin', 'breadcome' => 'Kuota', 'url' => 'kuota/', 'm_kuota' => 'active bg-gradient-primary', 'session' => $this->session);

        echo view('App\Views\kuota\kuota_list', $this->data);
    }
