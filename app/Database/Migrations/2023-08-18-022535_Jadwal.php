...
class Jadwal extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'dosentt_id' => ['type' => 'int', 'constraint' => 10, 'unsigned' => true, 'null' => true],
        ...
        $this->forge->addForeignKey('dosentt_id', 'penjabat', 'id', 'SET NULL', 'CASCADE');
